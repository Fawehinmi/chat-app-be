...
const accessChat = asyncHanler(async (req, res) => {
  ...
  if (!userId) {
    console.log("UserId param not passed");
...
const createGroupChat = asyncHanler(async (req, res) => {
...
const renameGroupChat = asyncHanler(async (req, res) => {
...
const addToGroup = asyncHanler(async (req, res) => {
...
const removeFromGroup = asyncHanler(async (req, res) => {
  let { chatId, userId } = req.body;
